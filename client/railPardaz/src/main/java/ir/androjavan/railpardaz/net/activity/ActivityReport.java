...
import ir.androjavan.railpardaz.net.AdapterReportList;
...
public class ActivityReport extends Activity implements OnClickListener{
	...
	TextView txtProfileName, txtTripName;
	ImageView btnSignOut, btnSync;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(mcursor.getCount() != 0)
		{
			do 
    		{
				...
				bundleReviewReport.vagonNum = " واگن : " + db.GetWagonNum(Integer.parseInt(mcursor.getString(3)));
				bundleReviewReport.comment = "کامنت : " + mcursor.getString(4);
				bundleReviewReport.status = mcursor.getInt(5);
