...
public class RailPardazDB {
    ...
    public static final String[] COLUMNS_REPORT = {FIELD_ID,FIELD_TOKEN,FIELD_ERROR_ID,FIELD_VAGON_ID,FIELD_COMMENT,FIELD_STATUS};
...
//            db.execSQL("DROP TABLE IF EXISTS "+TABLE_PRODUCT);
    ...
    public long InsertReport(BundleReport reportInfo)
    {
        ...
        initialValues.put(FIELD_VAGON_ID, reportInfo.vagonID);
    ...
    public String GetWagonNum(int wagonId)
    {
        String sql = "Select vagon_num from "+TABLE_VAGON+" where "+FIELD_VAGON_ID +" = " +wagonId;
        Cursor cursor = db.rawQuery(sql, null);
        cursor.moveToFirst();
        return cursor.getString(0);
    }

    public int GetWagonID(String wagonNum)
    {
        String sql = "Select vagon_id from "+TABLE_VAGON+" where "+FIELD_VAGON_NUM +" = " + wagonNum;
        Cursor cursor = db.rawQuery(sql, null);
        cursor.moveToFirst();
    ...
    public boolean SetSyncedReport(BundleReport bundleReport)
    {
    	...
    	initialValues.put(FIELD_VAGON_ID, bundleReport.vagonID);
    	...
    	return db.update(TABLE_REPORT, initialValues, 
    		...
    		+ "(" + FIELD_VAGON_ID + " = " + bundleReport.vagonID + ")AND"
